...
#*************************************************************************
#> void BuildPackage($package, $subdir, $aExe, $binDir, $dataDir, $dataDest)
#  -------------------------------------------------------------------------
...
sub BuildPackage
{
    my ($package, $subdir, $aExe, $binDir, $dataDir, $dataDest) = @_;
    ...
    if($needsToRun)
    {
        ...
        if($dataDir ne "")
        {
            ...
            util::RunCommand("cp $packageDir/$dataDir/* $dataDest");
        }
        `rm -rf $packageDir`;
    }
    else
